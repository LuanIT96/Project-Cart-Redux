        ...
        return (
            <footer className="page-footer center-on-small-only">
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-lg-2 ml-auto">
                            ...
                            <div className="social-section text-md-left">
                                <ul className="text-center">
                                    <li>
                                        <a href={link} className="btn-floating  btn-fb waves-effect waves-light">
                                            <i className="fa fa-facebook"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href={link} className="btn-floating  btn-ins waves-effect waves-light">
                                            <i className="fa fa-instagram"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href={link} className="btn-floating  btn-tw waves-effect waves-light">
                                            <i className="fa fa-twitter"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href={link} className="btn-floating  btn-yt waves-effect waves-light">
                                            <i className="fa fa-youtube"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href={link} className="btn-floating  btn-li waves-effect waves-light">
                                            <i className="fa fa-linkedin"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href={link} className="btn-floating  btn-dribbble waves-effect waves-light">
                                            <i className="fa fa-dribbble left"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href={link} className="btn-floating  btn-pin waves-effect waves-light">
                                            <i className="fa fa-pinterest"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href={link} className="btn-floating  btn-gplus waves-effect waves-light">
                        ...
                        <div className="col-lg-2">
                            ...
                            <ul>
                                <li>
                                    <a href={link}>Store Delivery</a>
                                </li>
                                <li>
                                    <a href={link}>Online Delivery</a>
                                </li>
                                <li>
                                    <a href={link}>Delivery Terms &amp; Conditions</a>
                                </li>
                                <li>
                                    <a href={link}>Tracking</a>
                                </li>
                            </ul>
                        </div>
                        <div className="col-lg-2">
                ...
                <div className="footer-copyright">
                    <div className="container-fluid">
                        © 2020 Design by:
                        <a href="http://thanhluanit.000webhostapp.com">Nguyễn Thành Luân</a>
                    </div>
                </div>
            </footer>
        );
